...
class TelegramBot:
    ...
    def __init__(self, token: str):
        ...
        logger.info("🤖 TelegramBot инициализирован для webhook режима (автоподписка при /start)")
    ...
    async def start_command(self, message: Message):
        ...
        try:
            ...
            # ✅ КЛЮЧЕВОЕ ИЗМЕНЕНИЕ: Автоматически подписываем пользователя
            ...
            # ✅ ИЗМЕНЕН ТЕКСТ: Информируем об автоподписке
...
- ✅ DataSourceAdapter - универсальный провайдер
  - Доступ к данным криптовалют
  - Доступ к данным фьючерсов
  - Единый интерфейс для стратегий
...
- ✅ Торговые сигналы с AI
  - Real-time через StrategyOrchestrator
  - MomentumStrategy активна
  - SignalManager фильтрует дубликаты
  - 🤖 AI анализ каждого сигнала от OpenAI

🔜 *Скоро будет добавлено:*
- 📊 On-demand анализ рынка
- 🤖 Интерактивный AI помощник
