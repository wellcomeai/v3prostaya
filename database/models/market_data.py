...
SQLAlchemy models for cryptocurrency market data storage.
...
class MarketDataCandle(Base):
    """
    OHLCV Candle data model for cryptocurrency market data
    ...
    symbol = Column(String(20), nullable=False, index=True, comment="Trading symbol (e.g., BTCUSDT)")
    ...
    # Metadata
    data_source = Column(String(50), nullable=True, default="bybit", comment="Data source (bybit, binance, etc.)")
    ...
    __table_args__ = (
        ...
        # Table configuration
        {
            'comment': 'OHLCV candle data for cryptocurrency market analysis',
    ...
    def __str__(self) -> str:
        ...
        return (f"{self.symbol} {self.interval} candle: "
...
logger.info("Market data models loaded successfully")
